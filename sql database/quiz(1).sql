...
INSERT INTO `mst_user` (`user_id`, `login`, `pass`, `username`, `address`, `city`, `phone`, `email`, `status`) VALUES
(17, '1', 'abhi', 'abhi', 'ekm', 'ekm', 2147483647, 'abhi@gmail.com', 1),
(19, '2', 'akhilesh', 'akhilesh', 'erkm', 'erkm', 2147483647, 'akhilesh@gmail.com', 1),
(20, 'bhe', 'bhe', 'abhi', 'abhi', 'abhi', 9896, 'k@g.com', 1);
...
('bvj0i49hf02putc8pn5p1o2s91', 12, 'to move the cursor end of the which key is used', 'end', 'home', 'pgup', 'pgdn', 1, 4),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'to move the cursor beginning of the which key is used', 'end', 'home', 'pgup', 'pgdn', 2, 3),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'on numeric key pad the keyu present are', '0 to 9 numbers', '+/*characters', 'arrow key', 'all of the above', 4, 1),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'to enter the number a special key slot is given on the keyboard which is', 'alphanumeric number', 'numeric key pad', 'function key', 'none of the above', 2, 2),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'in keyboard the function of which type keys change according the software', 'alphanumeric key', 'numeric key pad', 'function key', 'none of the above', 2, 3),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'to deleter the character towards left side is', 'backspace', 'del', 'inst', 'home', 1, 1),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'the delete the character right side of the cursor which key is used', 'inst', 'del', 'backspace', 'home', 2, 2),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'all arithmetic and logical processing is done in', 'ALU', 'CU', 'CPU', 'none of the above', 3, 1),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'the development of first generation computer is', '1955-1965', '1965-1975', '1945-1954', 'none', 3, 2),
('bvj0i49hf02putc8pn5p1o2s91', 12, '________is colled the brain of computer', 'mouse', 'keyboard', 'cpu', 'memory', 3, 3),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'which of the following is input device', 'speaker', 'printer', 'plotter', 'scanner', 4, 4),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'mouse is the type of device', 'input', 'pointing', 'scanning', 'none of the above', 2, 2),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'keybord is the type of device', 'input', 'pointing', 'output', 'sound', 1, 1),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'floppy disk is the type of memory', 'magnatic & secondarymain memory', 'main memory', 'o primary', 'none of the above', 1, 1),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'Personal Computer are the type of computer', 'super computer', 'mini computer', 'micro computer', 'mainframe computer', 3, 2),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'PC Stands for', 'pocket computer', 'personal computer', 'phisycal computer', 'personal card', 2, 2),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'RAM Stands for', 'Random Access Memory', 'Random accelerated Memory', 'Random Access Machenism', 'Random Accurace Mantan', 1, 1),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'the touchable part of computer is called as', 'hardware', 'software', 'programe', 'none', 1, 1),
('bvj0i49hf02putc8pn5p1o2s91', 12, 'if caps lock key is on then', 'small letters are printed', 'the lowercase letter are printed', 'capital letters print', 'none of the above', 3, 3),
('bvj0i49hf02putc8pn5p1o2s91', 12, '________are equivalent to 1 mb', '1022 kb', '1024 kb', '1024 byte', '1000 gb', 2, 2),
('o9dctvubiesrjj8f1o7cjtnb01', 14, 'Which city is known as The City of Palaces?', 'Kolkatta', 'Jerusalem', 'Mumbai', 'Udaipur', 1, 3);
